...
If you believe you have found a security issue in `rstream-go`, please avoid opening a public issue with exploit details.
...
- the affected package or command
- the version or commit you tested
- the impact you observed
- enough reproduction detail for the issue to be validated

We will treat security reports as a priority and work toward a coordinated fix and disclosure.
