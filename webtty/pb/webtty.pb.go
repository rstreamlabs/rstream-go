...
const (
	...
	// AES-256-GCM with a fresh 96-bit nonce generated by the AEAD implementation
	// and prefixed to EncryptedPayload.ciphertext. PayloadCrypto.nonce stays empty.
	PayloadCipherSuite_PAYLOAD_CIPHER_SUITE_AES_256_GCM_RANDOM_NONCE PayloadCipherSuite = 3
)
...
var (
	PayloadCipherSuite_name = map[int32]string{
		...
		3: "PAYLOAD_CIPHER_SUITE_AES_256_GCM_RANDOM_NONCE",
	}
	PayloadCipherSuite_value = map[string]int32{
		...
		"PAYLOAD_CIPHER_SUITE_AES_256_GCM_RANDOM_NONCE": 3,
	}
)
...
// authorized recipients. The suite identifier selects the complete,
// independently versioned construction.
...
const (
	...
	// P-256 ECDH plus HKDF-SHA256 and AES-256-GCM. The AEAD-generated nonce is
	// prefixed to KeyEnvelope.wrapped_key.
	KeyEnvelopeSuite_KEY_ENVELOPE_SUITE_P256_HKDF_SHA256_AES_256_GCM_RANDOM_NONCE KeyEnvelopeSuite = 3
)
...
var (
	KeyEnvelopeSuite_name = map[int32]string{
		...
		3: "KEY_ENVELOPE_SUITE_P256_HKDF_SHA256_AES_256_GCM_RANDOM_NONCE",
	}
	KeyEnvelopeSuite_value = map[string]int32{
		...
		"KEY_ENVELOPE_SUITE_P256_HKDF_SHA256_AES_256_GCM_RANDOM_NONCE": 3,
	}
)
...
const file_pb_webtty_proto_rawDesc = "" +
	...
	"\x1eOPEN_CAPABILITY_SESSION_CRYPTO\x10\x02*\xbf\x01\n" +
	"\x12PayloadCipherSuite\x12$\n" +
	" PAYLOAD_CIPHER_SUITE_UNSPECIFIED\x10\x00\x12$\n" +
	" PAYLOAD_CIPHER_SUITE_AES_256_GCM\x10\x01\x12*\n" +
	"&PAYLOAD_CIPHER_SUITE_CHACHA20_POLY1305\x10\x02\x121\n" +
	"-PAYLOAD_CIPHER_SUITE_AES_256_GCM_RANDOM_NONCE\x10\x03*\xf6\x01\n" +
	...
	"<KEY_ENVELOPE_SUITE_HPKE_X25519_HKDF_SHA256_CHACHA20_POLY1305\x10\x02\x12@\n" +
	"<KEY_ENVELOPE_SUITE_P256_HKDF_SHA256_AES_256_GCM_RANDOM_NONCE\x10\x03*R\n" +
