...
func init() {
	...
	forwardCmd.Flags().Bool("rstream-auth", false, "require rstream account authentication")
	forwardCmd.Flags().Bool("challenge-mode", false, "require an interactive challenge before access")
